...
class MjlabCollisionCfg:
    ...
    # MuJoCo uses three contact dimensions by default (normal plus two
    # tangential friction directions).  Newer mjlab versions require this
    # value explicitly when constructing CollisionCfg.

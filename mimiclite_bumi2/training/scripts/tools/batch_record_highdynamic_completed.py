#!/usr/bin/env python3
"""Record the six high-dynamic motions that passed the prior strict evaluation."""
...
OUT = ROOT / "outputs/highdynamic_completed6_mujoco_ppo_roa_finetune1000_onepass_ghost"
RUNS = OUT / "runs"
SUCCESS = OUT / "success"
FAILED = OUT / "failed"
STEP_DT = 0.02

...
from NoetixBumi.actuators import DelayedImplicitActuatorCfg
from NoetixBumi.assets import ASSET_DIR
...
BUMI_21DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        asset_path=f"{ASSET_DIR}/robots/bumi_v2/urdf/bumi.urdf",
    ...
    actuators={
        "legs": DelayedImplicitActuatorCfg(
            ...
            # armature={
            #     ".*_leg_yaw_joint": 0.0057,
            #     ".*_leg_roll_joint": 0.5150,
            #     ".*_leg_pitch_joint":  0.3994,
            #     ".*_knee_pitch_joint": 0.1513,
            # },
            min_delay=0,
            max_delay=6,
        ),
...
# Backward-compatible V2 aliases used by the mimic task configs.
# The primary names above were renamed from BUMI_V2_21DOF_*; keep the old
# exports so existing task imports remain valid.
BUMI_V2_21DOF_CFG = BUMI_21DOF_CFG
BUMI_V2_21DOF_ACTION_SCALE = BUMI_21DOF_ACTION_SCALE

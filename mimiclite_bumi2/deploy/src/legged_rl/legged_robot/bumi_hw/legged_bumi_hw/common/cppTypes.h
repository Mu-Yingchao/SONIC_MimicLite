...
struct RobotModel {
    ...
    int single_leg_freedom = 6;
    int waist_freedom = 1;
    int total_joint_freedom = 21;
};

struct RobotState {
    RobotState(){}
    RobotState(const int single_arm_freedom, const int single_leg_freedom, const int waist_freedom) {
        ...
        waist_joint_pos = VectorXd::Zero(waist_freedom);
        waist_joint_vel = VectorXd::Zero(waist_freedom);
        waist_joint_tor = VectorXd::Zero(waist_freedom);
    }

    Vector<double, Dynamic> left_arm_joint_pos, right_arm_joint_pos,
        left_leg_joint_pos, right_leg_joint_pos, waist_joint_pos;
    Vector<double, Dynamic> left_arm_joint_vel, right_arm_joint_vel,
        left_leg_joint_vel, right_leg_joint_vel, waist_joint_vel;
    Vector<double, Dynamic> left_arm_joint_tor, right_arm_joint_tor,
        left_leg_joint_tor, right_leg_joint_tor, waist_joint_tor;
...
struct WalkPhaseTransitionData {
    WalkPhaseTransitionData(const int single_arm_freedom, const int single_leg_freedom, const int waist_freedom) {
        last_phase_end_robot_state = RobotState(single_arm_freedom, single_leg_freedom, waist_freedom);
    }
...
struct JointCommand {
    JointCommand(const int single_arm_freedom, const int single_leg_freedom, const int waist_freedom) {
        ...
        waist_joint_torcmd = VectorXd::Zero(waist_freedom);
        waist_joint_poscmd = VectorXd::Zero(waist_freedom);
        waist_joint_velcmd = VectorXd::Zero(waist_freedom);
        waist_joint_kp = VectorXd::Zero(waist_freedom);
        waist_joint_kd = VectorXd::Zero(waist_freedom);
    }
    ...
    void zero_joint_cmd() {
        ...
        waist_joint_torcmd.setZero();
        waist_joint_poscmd.setZero();
        waist_joint_velcmd.setZero();
        waist_joint_kp.setZero();
        waist_joint_kd.setZero();
    }
    ...
    Vector<double, Dynamic> left_arm_joint_torcmd, right_arm_joint_torcmd,
        left_leg_joint_torcmd, right_leg_joint_torcmd, waist_joint_torcmd;
    Vector<double, Dynamic> left_arm_joint_poscmd, right_arm_joint_poscmd,
        left_leg_joint_poscmd, right_leg_joint_poscmd, waist_joint_poscmd;
    Vector<double, Dynamic> left_arm_joint_velcmd, right_arm_joint_velcmd,
        left_leg_joint_velcmd, right_leg_joint_velcmd, waist_joint_velcmd;
    Vector<double, Dynamic> left_arm_joint_kp, right_arm_joint_kp,
        left_leg_joint_kp, right_leg_joint_kp, waist_joint_kp;
    Vector<double, Dynamic> left_arm_joint_kd, right_arm_joint_kd,
        left_leg_joint_kd, right_leg_joint_kd, waist_joint_kd;
};
